  ...
  return (
    <div className='w-100 mt-5'>
      <div className='text-center'>
        ...
        <Link to="/history/month"><button  style={{background:" rgb(243, 223, 227)",color:"black"}} className='btn px-3 mx-2'>Month</button></Link>
        <Link to="/history/year"><button style={{background:" #F85899",color:"white"}}  className='btn px-3 mx-2'>Year</button></Link>
      </div>
      <Outlet />
    </div>
  );
