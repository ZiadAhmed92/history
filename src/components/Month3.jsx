...
export let Calm = [];
  ...
  return (
    ...
    <Link to="/speech/history/year"><button style={{background:" rgb(243, 223, 227)",color:"black"}} className='btn  px-3 mx-2' > 1</button></Link>
    ...
    <Link to="/speech/history/year/month3"><button style={{background:" #F85899",color:"white"}} className='btn px-3 mx-2'> 3</button></Link>
  </div> 
    </div>
  );
}
