...
const Day = () => {
  ...
  // data1 = [
  //   { x: "Angry", y:15, text: "Angry", fill: "#FF2414" },
  //   { x: "Sad", y:15, text: "Sad", fill: "#0057AE" },
  //   { x: "Happy", y:15, text: "Happy", fill: "#FFEB00" },
  //   { x: "Natural", y:15, text: "Natural", fill: "#CFD8DC" },
  //   { x: "Calm", y:15, text: "Calm", fill: "#00BEFF" },
  //   { x: "Fear", y:15, text: "Fear", fill: "#B7043C" },
  //   { x: "Disgusted", y:15, text: "Disgusted", fill: "#A1E533" },
  //   { x: "Surprised", y:15, text: "Surprised", fill: "#FF6900" }
  // ];
  data1 = [
